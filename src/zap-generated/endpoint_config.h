...
#define GENERATED_MIN_MAX_DEFAULTS                                                                                     \
	{                                                                                                              \
		...
		{ (uint16_t)0x0, (uint16_t)0x0, (uint16_t)0x2 }, /* StartUpOnOff */                                    \
                                                                                                                       \
			/* Endpoint: 5, Cluster: Fan Control (server) */                                               \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 14, 116 }, { ZAP_CLUSTER_INDEX(14), 3, 27 }, { ZAP_CLUSTER_INDEX(17), 3, 27 }, \
			{ ZAP_CLUSTER_INDEX(20), 3, 27 }, { ZAP_CLUSTER_INDEX(23), 5, 47 },                            \
			{ ZAP_CLUSTER_INDEX(28), 4, 32 },                                                              \
	}
...
#define FIXED_DEVICE_TYPES                                                                                             \
	{                                                                                                              \
		{ 0x0016, 1 }, { 0x0302, 1 }, { 0x0305, 1 }, { 0x0307, 1 }, { 0x0100, 1 },                             \
		{                                                                                                      \
			0x002B, 1                                                                                      \
		}                                                                                                      \
	}
